            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <p><strong>Tingkat Kecenderungan Perilaku Judi Online :</strong></p>
                            <p>{{ $penyakit->nama }}</p>
                        </div>
                        <div class="col-3">
                            <p><strong>Id Tingkat kecenderungan Perilaku Judi Online :</strong></p>
                            <p>{{ $penyakit->id }}</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p><strong>Deskripsi Tingkat Kecenderungan Perilaku Judi Online :</strong></p>
