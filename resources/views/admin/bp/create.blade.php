                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control cb @error('gejala_id') is-invalid @enderror" id="gejala"
                                name="gejala_id">
                                <option disabled selected>-- Pilih Kecenderungan Perilaku Judi Online --</option>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <select class="form-control cb @error('gejala_id') is-invalid @enderror" id="penyakit"
                                name="penyakit_id">
                                <option disabled selected>-- Pilih Tingkat Kecenderungan Perilaku Judi Online --</option>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <select name="cf" id="cf" class="form-control">
                                ...
                                <option value="-1">Sangat Tidak Setuju (-1.0)</option>
                                <option value="-0.5">Tidak Setuju (-0.5)</option>
                                <option value="0.5">Setuju (0.5)</option>
