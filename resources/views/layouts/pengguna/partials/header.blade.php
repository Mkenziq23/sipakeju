        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li class="{{ $title == 'Diagnosis' ? 'active' : null }}">
                    <a href="{{ route('pengguna.diagnosa.index') }}">Identifikasi</a>
                </li>
                <li><a href="{{ route('pengguna.penyakit.index') }}">Info Tingkat Kecenderungan Perilaku Judi Online</a>
                </li>
                ...
                @auth
                    <li><a href="{{ route('admin.dashboard') }}" class="appointment-btn scrollto text-white text-center"
                            style="width: 100px">Dashboard</a></li>
                @else
