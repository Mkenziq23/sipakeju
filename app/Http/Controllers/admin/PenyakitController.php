...
{
    protected $title = 'Tingkat Kecenderungan Perilaku Judi Online';
    ...
    public function store(PenyakitRequest $request)
    {
        ...
        $this->notification('success', 'Berhasil', 'Data Tingkat Kecenderungan Berhasil Ditambah');
    ...
    public function update(PenyakitRequest $request, Penyakit $penyakit)
    {
        ...
        $this->notification('success', 'Berhasil', 'Data Tingkat Kecenderungan Berhasil Diupdate');
    ...
    public function destroy(Penyakit $penyakit)
    {
        File::delete('assets/gambar/' . $penyakit->gambar);
        $penyakit->delete();
        $this->notification('success', 'Berhasil', 'Data Tingkat Kecenderungan Berhasil Dihapus');
        return redirect(route('admin.penyakit.index'));
    }
}
